...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Oncliff Mwirigi";
        $("#favicon").attr("href","images/potrait.jpg");
    }
    else {
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["Front-End development", "Cybersecurity", "Network Administration", "Tech Communities"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
